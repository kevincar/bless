...
class BlueZLEAdvertisement(ServiceInterface):
    ...
    def __init__(
        ...
        # - wheb bluez compiled with such option (usually it is)
        # - and when "bluetoothd" is started with -E, --experimental option (usually it's not)
        # They are taken into account only with Kernel v 5.11+ and BlueZ v5.65+.
        # It's a known fact that BlueZ verions 5.63-5.64 have broken Dbus part for LEAdvertisingManager
        # and do not work properly when the Experimental mode enabled.
